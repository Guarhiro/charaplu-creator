...
ルール：
- 出力は4000字以内に厳守（なるべく情報を詳述し上限いっぱいのボリュームにすること）
- {{user}}表記を維持
- 【】セクション構造を維持
- 好感度・執着度の内部管理システムを維持
- キーワードブック参照指示を含める
...
キーワードブックのノート情報を、400字以内で最大限活用した濃密な設定文に書き換えてください。
ルール：
- 400字以内に厳守（日本語文字数）
- {{user}}表記を維持
- 体言止め・圧縮表現で字数を節約
...
チャット開始時のAIキャラの最初の発言を、臨場感あふれる文章に書き換えてください。
ルール：
- 500字以内に厳守
- {{user}}表記を維持（二重波括弧）
- キャラの台詞は「」で囲む
...
キャラの紹介文を、魅力的で読者を惹きつける文章に書き換えてください。
ルール：
- 250字以内に厳守（なるべく情報を詰めて250字ギリギリまで克明に描写すること）
- {{user}}表記を維持
